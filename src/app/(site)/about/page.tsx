...
export default function About() {
    ...
    const techStack: Record<string, TechStackItem[]> = {
        frontend: [
            ...
            {
                name: "React 18",
                description: language === "en" ? "UI library" : "UI 库",
                url: "https://react.dev",
            },
            {
                name: "TypeScript",
                description:
                    language === "en" ? "Type-safe JavaScript" : "类型安全的 JavaScript",
            ...
            {
                name: "shadcn/ui",
                description: language === "en" ? "Re-usable components" : "可重用组件",
        ...
        backend: [
            {
                ...
                description:
                    language === "en" ? "Backend API endpoints" : "后端 API 端点",
                url: "https://nextjs.org/docs/api-routes/introduction",
            },
            {
                name: "Prisma",
                description:
                    language === "en" ? "Type-safe database ORM" : "类型安全的数据库 ORM",
                url: "https://www.prisma.io",
            },
            {
                name: "PostgreSQL",
                description: language === "en" ? "Database" : "数据库",
                url: "https://www.postgresql.org",
            },
            {
                name: "NextAuth.js",
                description: language === "en" ? "Authentication" : "身份认证",
        ...
        features: [
            {
                name: "GitHub OAuth",
                description: language === "en" ? "Login with GitHub" : "使用 GitHub 登录",
            },
            {
                name: "Markdown Support",
                description:
                    language === "en"
                        ? "Cherry Markdown & Unified"
                        : "Cherry Markdown 和 Unified 支持",
            },
            {
                ...
                description:
                    language === "en"
                        ...
                        : "使用 rehype-pretty-code 和 Shiki 的代码高亮",
            },
            {
                name: "Math Equations",
                description:
                    language === "en" ? "KaTeX integration" : "KaTeX 数学公式支持",
            },
            {
                name: "Comments",
                description:
        ...
        deployment: [
            {
                name: "Docker",
                description: language === "en" ? "Containerization" : "容器化",
            },
            {
                name: "GitHub Actions",
        ...
        <main className="min-h-[calc(100vh-56px)] p-6 md:p-8 animate-fade-up">
            <div className="max-w-5xl mx-auto space-y-12">
                ...
                <section className="text-center space-y-4 py-8">
                    <h1 className="text-4xl md:text-5xl font-mono font-bold leading-[1.4] pb-1 bg-linear-to-r from-gray-900 to-gray-600 dark:from-gray-100 dark:to-gray-400 bg-clip-text text-transparent">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        {[
                            ...
                            },
                            {
                                ...
                                description:
                                    language === "en"
                                        ? "GitHub OAuth integration for user management"
                                        : "GitHub OAuth 集成用户管理",
                            },
                            {
                                title:
                            ...
                            },
                            {
                                ...
                                description:
                                    language === "en"
                                        ? "Track and manage post revisions"
                                        : "跟踪和管理帖子修订",
                            },
                            {
                                title:
